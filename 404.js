...
function App() {
  return(
    ...
    <h1 style={{
      fontSize:'4rem',
      color:'black'
    }}> You Struck a wrong or broken link</h1>
    <h1>Welcome to the <span className='blue'>Ultimate </span>all in one <span className='green'>Speech </span>and <span className='blue'>Text </span>Tool</h1>
